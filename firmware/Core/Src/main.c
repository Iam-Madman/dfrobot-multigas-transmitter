...
/* Definitions for ADC_AverageTask */
osThreadId_t ADC_AverageTaskHandle;
const osThreadAttr_t ADC_AverageTask_attributes = {
  .name = "ADC_AverageTask",
  .stack_size = 128 * 4,
...
int main(void)
{
  ...
  /* Create the thread(s) */
  /* creation of ADC_AverageTask */
  ADC_AverageTaskHandle = osThreadNew(Start_ADC_AverageTask, NULL, &ADC_AverageTask_attributes);
...
/**
  * @brief  Function implementing the ADC_AverageTask thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_Start_ADC_AverageTask */
void Start_ADC_AverageTask(void *argument)
{
  /* USER CODE BEGIN 5 */
  uint32_t flags;
